...
<form method="POST" action="{{ route('shorturl.user.update', $shortUrl) }}"
    ...
    <div style="background: #fff; border: 1px solid #E5E7EB; border-radius: 12px; margin-bottom: 16px; overflow: hidden;">
        <div @click="toggle('basic')" style="padding: 16px 20px; cursor: pointer; display: flex !important; justify-content: space-between !important; align-items: center !important; user-select: none; background: #F3F4F6; min-height: 52px;"
    ...
    <div style="background: #fff; border: 1px solid #E5E7EB; border-radius: 12px; margin-bottom: 16px; overflow: hidden;">
        <div @click="toggle('security')" style="padding: 16px 20px; cursor: pointer; display: flex !important; justify-content: space-between !important; align-items: center !important; user-select: none; background: #F3F4F6; min-height: 52px;"
    ...
    <div style="background: #fff; border: 1px solid #E5E7EB; border-radius: 12px; margin-bottom: 16px; overflow: hidden;">
        <div @click="toggle('utm')" style="padding: 16px 20px; cursor: pointer; display: flex !important; justify-content: space-between !important; align-items: center !important; user-select: none; background: #F3F4F6; min-height: 52px;"
    ...
    <div style="background: #fff; border: 1px solid #E5E7EB; border-radius: 12px; margin-bottom: 24px; overflow: hidden;">
        <div @click="toggle('preview')" style="padding: 16px 20px; cursor: pointer; display: flex !important; justify-content: space-between !important; align-items: center !important; user-select: none; background: #F3F4F6; min-height: 52px;"
