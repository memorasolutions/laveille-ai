...
<div class="container" style="max-width: 800px; margin: 0 auto;">
    ...
    <div style="display: flex !important; flex-wrap: wrap !important; gap: 12px; margin-bottom: 32px;">
        ...
        <div style="flex: 1 !important; min-width: 120px; background: #fff; border: 1px solid #E5E7EB; border-radius: 12px; padding: 20px; text-align: center;">
            <div style="font-size: 1.3rem; font-weight: 800; color: var(--c-dark, #1A1D23);">{{ $shortUrl->created_at->diffForHumans(null, true) }}</div>
    ...
    <div style="background: #fff; border: 1px solid #E5E7EB; border-radius: 12px; padding: 20px; margin-bottom: 24px;">
        ...
        <div style="display: flex !important; align-items: flex-end !important; height: 160px; gap: 3px; overflow-x: auto; padding-bottom: 24px;">
            @foreach(array_slice($clicksByDay, -30) as $day)
                <div style="flex: 1 !important; min-width: 16px; display: flex !important; flex-direction: column !important; align-items: center !important; justify-content: flex-end !important; height: 100%;" title="{{ $day['date'] }} — {{ $day['count'] }} {{ __('clics') }}">
