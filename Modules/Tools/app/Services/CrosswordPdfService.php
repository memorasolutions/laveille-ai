...
{
    public function renderBlank(array $generated, ?string $title = null, ?string $playUrl = null): string
    {
    ...
    public function renderSolution(array $generated, ?string $title = null, ?string $playUrl = null): string
    {
