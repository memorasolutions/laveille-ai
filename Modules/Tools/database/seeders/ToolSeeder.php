...
class ToolSeeder extends Seeder
{
    public function run(): void
    {
        $tools = [
            ...
            ['name' => 'Anonymiseur de texte', 'slug' => 'anonymiseur', 'description' => 'Remplacez les données personnelles avant d\'envoyer un texte à une IA, puis restaurez-les dans la réponse. 100 % local, réversible par conception.', 'icon' => '🕵️', 'sort_order' => 11, 'category' => 'securite', 'is_under_construction' => false],
        ];
