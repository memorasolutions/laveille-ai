...
class ToolSeeder extends Seeder
{
    public function run(): void
    {
        $tools = [
            ...
            ['name' => 'Anonymiseur de texte', 'slug' => 'anonymiseur', 'description' => 'Anonymisez vos textes avant de les envoyer à une IA. 100 % local, conforme Loi 25 et RGPD.', 'icon' => '🕵️', 'sort_order' => 11, 'category' => 'securite', 'is_under_construction' => false],
        ];
