...
.cw-grid-wrap { text-align: center; margin: 0 auto 16px auto; page-break-inside: avoid; }
table.cw-grid { table-layout: fixed; border-collapse: collapse; margin: 0 auto; page-break-inside: avoid; }
...
table.cw-grid td .num { font-size: {{ max(5, intval(($cellSize ?? 28) * 0.22)) }}pt; }
