        ...
        <ol class="lv-popular-list" style="list-style:none; padding:0; margin:0; counter-reset:popular-counter;">
            @foreach($popularPosts as $post)
                <li style="counter-increment:popular-counter; position:relative; padding-left:36px; margin-bottom:8px;">
                    ...
                    <a href="{{ route('authors.post.show', [$author->slug, $post->slug]) }}" class="lv-popular-card" style="display:block; padding:10px 12px; min-height:44px; text-decoration:none; color:inherit; border-radius:8px; transition:background 200ms;">
