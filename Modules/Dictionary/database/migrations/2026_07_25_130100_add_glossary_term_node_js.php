...
/**
 * Ajout du terme "Node.js" (alias "Node") au glossaire (2026-07-25), en réponse à la question
 * utilisateur "Node et Node.js, est-ce la même chose ?" - même chose, pas 2 concepts, une seule
 * fiche avec alias plutôt que deux fiches redondantes (anti-doublons).
 *
 * Sources (nodejs.org previous-releases, Wikipedia) vérifiées joignables (curl, HTTP 200).
 * Catégorie résolue dynamiquement par slug.
 *
 * Données dans database/data/glossaire-batch-2026-07-25-node-js.json.
...
return new class extends Migration
{
    ...
    {
        $path = __DIR__.'/../data/glossaire-batch-2026-07-25-node-js.json';
        if (! is_file($path)) {
            return [];
        }
