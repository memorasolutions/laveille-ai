...
/**
 * Ajout du terme "nvm" au glossaire (2026-07-25, demandé explicitement via /glossaire "nvm").
 *
 * Contenu et sources (dépôts officiels nvm-sh/nvm et coreybutler/nvm-windows) vérifiés joignables
 * (curl, HTTP 200) avant écriture. Catégorie résolue dynamiquement par slug.
 *
 * Données dans database/data/glossaire-batch-2026-07-25-nvm.json.
...
return new class extends Migration
{
    ...
    {
        $path = __DIR__.'/../data/glossaire-batch-2026-07-25-nvm.json';
        if (! is_file($path)) {
            return [];
        }
