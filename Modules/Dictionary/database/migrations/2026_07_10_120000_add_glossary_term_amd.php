...
/**
 * Ajout du terme "AMD" au glossaire (2026-07-10) : Advanced Micro Devices, fondee en 1969,
 * fabricant americain de semi-conducteurs (CPU Ryzen/EPYC, GPU Radeon/Instinct), ligne
 * d'accelerateurs IA/HPC Instinct MI300 sur architecture CDNA 3.
 *
 * Contenu redige via mcp__hermes__model_invoke (task_type=synthesis) a partir de faits
 * fournis et verifies - sources amd.com/en/corporate/about-amd.html et Wikipedia FR.
 *
 ...
 *
 * Donnees dans database/data/glossaire-batch-2026-07-10-amd.json.
...
return new class extends Migration
{
    ...
    {
        $path = __DIR__.'/../data/glossaire-batch-2026-07-10-amd.json';
        if (! is_file($path)) {
            return [];
        }
