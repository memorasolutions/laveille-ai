...
/**
 * Ajout du terme "PyTorch" au glossaire (2026-07-10) : bibliotheque Python open-source
 * d'apprentissage profond, developpee par Facebook AI Research (Meta AI), premiere
 * sortie en 2016, graphe de calcul dynamique (autograd, define-by-run).
 *
 * Contenu redige via mcp__hermes__model_invoke (task_type=synthesis) a partir de faits
 * fournis et verifies - sources pytorch.org et Wikipedia FR.
 *
 ...
 *
 * Donnees dans database/data/glossaire-batch-2026-07-10-pytorch.json.
...
return new class extends Migration
{
    ...
    {
        $path = __DIR__.'/../data/glossaire-batch-2026-07-10-pytorch.json';
        if (! is_file($path)) {
            return [];
        }
