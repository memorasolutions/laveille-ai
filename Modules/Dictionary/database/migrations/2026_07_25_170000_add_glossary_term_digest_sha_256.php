...
/**
 * Ajout du terme "Digest SHA-256" au glossaire (2026-07-25), demandé via /glossaire "digest SHA-256"
 * (fonction de hachage cryptographique, pertinente pour la vérification d'intégrité de fichiers/paquets
 * évoquée dans l'article OpenClaw).
 *
 * Sources (NIST FIPS 180-4, NIST CSRC collisions SHA-1) vérifiées joignables (curl, HTTP 200).
 * Dates précises (FIPS 180-2 le 1er août 2002, FIPS 180-4 finalisé le 4 août 2015, SHAttered
 * février 2017) confirmées par validation croisée Perplexity + Codex.
 * Catégorie résolue dynamiquement par slug (securite-et-ethique).
 *
 * Données dans database/data/glossaire-batch-2026-07-25-digest-sha-256.json.
...
return new class extends Migration
{
    ...
    {
        $path = __DIR__.'/../data/glossaire-batch-2026-07-25-digest-sha-256.json';
        if (! is_file($path)) {
            return [];
        }
