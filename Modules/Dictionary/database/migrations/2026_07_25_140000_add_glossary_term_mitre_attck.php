...
/**
 * Ajout du terme "MITRE ATT&CK" au glossaire (2026-07-25), demandé via /glossaire "MITRE ATT&CK"
 * (terme cité dans l'article de blog OpenClaw pour la technique de persistance T1569.001).
 *
 * Sources (attack.mitre.org, journal des mises à jour v19) vérifiées joignables (curl, HTTP 200).
 * Catégorie résolue dynamiquement par slug (securite-et-ethique).
 *
 * Données dans database/data/glossaire-batch-2026-07-25-mitre-attck.json.
...
return new class extends Migration
{
    ...
    {
        $path = __DIR__.'/../data/glossaire-batch-2026-07-25-mitre-attck.json';
        if (! is_file($path)) {
            return [];
        }
