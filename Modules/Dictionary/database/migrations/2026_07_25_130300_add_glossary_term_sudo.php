...
/**
 * Ajout du terme "sudo" au glossaire (2026-07-25), lié à l'article de blog OpenClaw (recommandation
 * explicite de ne jamais installer via sudo).
 *
 * Sources (sudo.ws documentation officielle, OWASP moindre privilège) vérifiées joignables
 * (curl, HTTP 200). Catégorie résolue dynamiquement par slug.
 *
 * Données dans database/data/glossaire-batch-2026-07-25-sudo.json.
...
return new class extends Migration
{
    ...
    {
        $path = __DIR__.'/../data/glossaire-batch-2026-07-25-sudo.json';
        if (! is_file($path)) {
            return [];
        }
