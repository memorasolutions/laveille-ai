...
/**
 * Ajout du terme "Laravel Herd" au glossaire (2026-07-25), demandé via /glossaire "Laravel Herd"
 * (environnement de développement local natif pour PHP/Laravel, utilisé sur ce projet même).
 *
 * Sources (Laravel News annonce, herd.laravel.com officiel) vérifiées joignables (curl, HTTP 200).
 * Dates exactes (21 juillet 2023 macOS, Windows 1.0.0 le 26 mars 2024) confirmées par
 * validation croisée Codex après recherche Perplexity initiale moins précise.
 * Catégorie résolue dynamiquement par slug (outils-et-techniques).
 *
 * Données dans database/data/glossaire-batch-2026-07-25-laravel-herd.json.
...
return new class extends Migration
{
    ...
    {
        $path = __DIR__.'/../data/glossaire-batch-2026-07-25-laravel-herd.json';
        if (! is_file($path)) {
            return [];
        }
