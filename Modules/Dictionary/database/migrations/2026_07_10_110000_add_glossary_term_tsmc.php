...
/**
 * Ajout du terme "TSMC" au glossaire (2026-07-10) : Taiwan Semiconductor Manufacturing
 * Company, fondee en 1987 par Morris Chang, leader mondial de la fonderie de semi-conducteurs
 * (plus de 60% de part de marche), pionniere du modele pure-play foundry.
 *
 * Contenu redige via mcp__hermes__model_invoke (task_type=synthesis) a partir de faits
 * fournis et verifies - sources tsmc.com/english/aboutTSMC et Wikipedia FR.
 *
 ...
 *
 * Donnees dans database/data/glossaire-batch-2026-07-10-tsmc.json.
...
return new class extends Migration
{
    ...
    {
        $path = __DIR__.'/../data/glossaire-batch-2026-07-10-tsmc.json';
        if (! is_file($path)) {
            return [];
        }
