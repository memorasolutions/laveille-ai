...
/**
 * Ajout du terme "MTIA" au glossaire (2026-07-10) : puce d'intelligence artificielle
 * maison de Meta (Meta Training and Inference Accelerator), annoncee en mai 2023,
 * feuille de route etendue (MTIA 300/400/450/500) en mars 2026.
 *
 * Contenu redige via mcp__hermes__model_invoke (task_type=synthesis) a partir de faits
 * fournis et verifies - sources ai.meta.com/blog (2023) et about.fb.com/news (2026).
 *
 ...
 *
 * Donnees dans database/data/glossaire-batch-2026-07-10-mtia.json.
...
return new class extends Migration
{
    ...
    {
        $path = __DIR__.'/../data/glossaire-batch-2026-07-10-mtia.json';
        if (! is_file($path)) {
            return [];
        }
