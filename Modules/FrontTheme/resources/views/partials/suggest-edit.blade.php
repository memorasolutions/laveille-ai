...
<div x-data="{ showSuggest: false }" style="margin-bottom: 12px;">
    <button type="button" @click="showSuggest = !showSuggest"
            style="background: none; border: 1px solid #D1D5DB; border-radius: 6px; padding: 6px 12px; font-size: 12px; color: #374151; cursor: pointer; font-weight: 600; transition: all 0.2s;"
        ...
        @auth
            <form action="{{ $route }}" method="POST">
                ...
                <div style="margin-bottom: 12px;">
                    <label style="display: block; font-size: 12px; font-weight: 600; color: #374151; margin-bottom: 4px;">{{ __('Champ concerné') }}</label>
                ...
                <div style="margin-bottom: 12px;">
                    <label style="display: block; font-size: 12px; font-weight: 600; color: #374151; margin-bottom: 4px;">{{ __('Votre suggestion') }} *</label>
                ...
                <div style="margin-bottom: 12px;">
                    <label style="display: block; font-size: 12px; font-weight: 600; color: #374151; margin-bottom: 4px;">{{ __('Pourquoi ?') }} <span style="color: #374151;">({{ __('optionnel') }})</span></label>
                ...
                <div style="display: flex; justify-content: flex-end; gap: 8px;">
                    <button type="button" @click="showSuggest = false" style="background: none; border: none; color: #374151; font-size: 13px; cursor: pointer;">{{ __('Annuler') }}</button>
