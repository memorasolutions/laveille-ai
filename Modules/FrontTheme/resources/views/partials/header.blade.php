                                    ...
                                    <div style="display:flex!important;gap:24px;">
                                        ...
                                        <div style="flex:1!important;">
                                            ...
                                            <a href="{{ route('acronyms.index') }}" style="display:flex!important;gap:10px;padding:8px 10px;border-radius:8px;text-decoration:none!important;color:inherit;transition:background .15s;" onmouseover="this.style.background='#F9FAFB'" onmouseout="this.style.background='transparent'">
                                                <span style="font-size:18px;line-height:1;">🎓</span>
                                                <div><div style="font-weight:700;font-size:14px;color:var(--c-dark, #1A1D23);">{{ __('Acronymes éducation') }}</div><div style="font-size:12px;color:var(--c-text-muted, #6E7687);">{{ __('307 acronymes du Québec') }}</div></div>
                                            </a>
                                            @endif
                                        </div>
                    ...
                    <div class="header-right">
                        ...
                        <div x-data="{ open: false }" style="display:inline-block;position:relative;margin-right:8px;vertical-align:middle;">
                            ...
                            <div x-show="open" x-cloak x-transition style="position:absolute;right:0;top:40px;background:#fff;border:1px solid #e5e7eb;border-radius:12px;box-shadow:0 8px 24px rgba(0,0,0,0.12);width:220px;z-index:9999;padding:8px 0;">
                                ...
                                @if(Route::has('shorturl.user.index'))<a href="{{ route('shorturl.user.index') }}" style="display:block;padding:10px 16px;color:var(--c-dark);text-decoration:none!important;font-size:13px;font-weight:500;" onmouseover="this.style.background='#f9fafb'" onmouseout="this.style.background='transparent'">🔗 {{ __('Mes liens courts') }}</a>@endif
