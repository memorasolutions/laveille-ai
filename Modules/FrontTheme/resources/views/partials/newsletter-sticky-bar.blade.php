<div id="newsletter-sticky-bar" x-data="{ dismissed: false, checkDismissal() { const dismissedAt = localStorage.getItem('newsletter_sticky_dismissed_at'); if (dismissedAt && (Date.now() - parseInt(dismissedAt)) < 30*24*60*60*1000) { this.dismissed = true; } } }" x-init="checkDismissal()" x-show="!dismissed" style="display: none; position: fixed; top: 0; left: 0; right: 0; z-index: 9999; height: 44px; padding: 8px 16px; background: linear-gradient(to right, #0B7285, #095a69); color: white; font-size: 0.875rem; box-sizing: border-box;">
