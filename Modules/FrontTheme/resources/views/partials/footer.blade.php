            ...
            <div class="row">
                <div class="col col-xs-12">
                    <p class="copyright"> Copyright &copy; {{ date('Y') }} {{ config('app.name') }}. {{ __('Tous droits réservés.') }}
                        <span style="font-size:10px;color:rgba(255,255,255,0.35);margin-left:8px;font-variant-numeric:tabular-nums;" title="{{ __('Version applicative') }}">{{ function_exists('lv_version') ? lv_version() : 'v?' }}</span>
                    </p>
