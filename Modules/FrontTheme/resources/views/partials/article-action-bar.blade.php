...
<div class="aab" x-data="{
    ...
    {{-- Copier le lien --}}
    <button class="aab-btn" @click="navigator.clipboard.writeText(window.location.href); window.toast('{{ __('Lien copié') }}', 'success', 2000); copied = true; setTimeout(() => copied = false, 2000)">
