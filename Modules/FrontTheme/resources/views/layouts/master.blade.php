...
@include('fronttheme::partials.newsletter-sticky-bar')
    ...
    <div x-data="{ copied: false, linkedinCopied: false, showLiModal: false, liUrl: '', liText: {{ \Illuminate\Support\Js::from($shareClipboard) }}, openLi() { window.open(this.liUrl, '_blank'); this.showLiModal = false; } }" class="share-float">
        ...
        <div class="share-sidebar">
            ...
            <a href="{{ lv_social('messenger') }}" target="_blank" rel="noopener" aria-label="{{ __('Envoyer via Messenger') }}" class="share-btn share-msg" @click.prevent="window.__openShare($el.href,liText,'Messenger','#0099FF','message')">
