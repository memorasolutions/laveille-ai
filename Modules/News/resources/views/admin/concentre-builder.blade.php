...
{{-- Ticket #2210 (2026-09-05) : le <script defer> de public/assets/admin/news-article-picker.js
     a déménagé dans news::admin.partials.news-article-picker (inclus plus haut, ligne 93), sous
...
function concentreBuilder(opts) {
    ...
    // échouer concentreBuilder() au complet et Alpine cascaderait en dizaines d'erreurs sur
    ...
    if (typeof NewsArticlePicker === 'undefined') {
        console.error('[concentre-builder] window.NewsArticlePicker introuvable (script assets/admin/news-article-picker.js non chargé) - sélecteur d\'actualités inopérant, reste du panneau conservé.');
    } else {
