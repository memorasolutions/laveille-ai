...
<a href="{{ lv_social('facebook') }}" style="text-decoration:none;color:#94a3b8;">Facebook</a> &nbsp;|&nbsp; <a href="{{ config('app.url') }}" style="text-decoration:none;color:#94a3b8;">{{ str_replace(['https://', 'http://'], '', config('app.url')) }}</a>
