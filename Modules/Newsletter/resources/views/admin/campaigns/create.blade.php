...
<div class="row gy-3">
    ...
    <div class="col-md-4">
        <div class="card">
            ...
            <div class="card-body">
                <p class="text-muted text-sm mb-2">La campagne sera créée en statut <strong>brouillon</strong>.</p>
                <p class="text-muted text-sm mb-0">Vous pourrez l'envoyer depuis la liste des campagnes.</p>
            </div>
        </div>
    </div>
</div>
