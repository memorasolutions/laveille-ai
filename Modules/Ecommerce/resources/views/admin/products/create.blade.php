@extends('backoffice::themes.backend.layouts.admin', ['title' => 'Nouveau produit', 'subtitle' => 'Boutique'])
...
<div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-3">
    <h4 class="fw-bold mb-0 d-flex align-items-center gap-2">
        <i data-lucide="plus-circle" class="icon-md text-primary"></i> Nouveau produit
    </h4>
</div>
