...
@extends('backoffice::themes.backend.layouts.admin', ['title' => __('Nouveau produit'), 'subtitle' => __('Boutique')])
...
<div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-3">
    <h4 class="fw-bold mb-0 d-flex align-items-center gap-2">
        <i data-lucide="plus-circle" class="icon-md text-primary"></i> {{ __('Nouveau produit') }}
    </h4>
</div>
            ...
            <div class="card mb-3">
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" id="inputName" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" required>
                        @error('name') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="inputSlug">{{ __('Slug (URL)') }}</label>
                        <input type="text" name="slug" id="inputSlug" class="form-control @error('slug') is-invalid @enderror" value="{{ old('slug') }}" required>
            ...
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <div class="mb-0">
                        ...
                        <input type="text" name="sku" class="form-control form-control-sm @error('sku') is-invalid @enderror" value="{{ old('sku') }}">
