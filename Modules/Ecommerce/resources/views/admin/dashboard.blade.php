...
@extends('backoffice::themes.backend.layouts.admin', ['title' => __('Tableau de bord'), 'subtitle' => __('Boutique')])
...
<div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-3">
    <h4 class="fw-bold mb-0 d-flex align-items-center gap-2">
        <i data-lucide="store" class="icon-md text-primary"></i> {{ __('Tableau de bord e-commerce') }}
    </h4>
</div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <p class="text-muted mb-1">{{ __("Chiffre d'affaires") }}</p>
    ...
    <div class="col-12 col-md-6 col-xl-3 mb-3">
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <p class="text-muted mb-1">{{ __('Commandes') }}</p>
    ...
    <div class="col-12 col-md-6 col-xl-3 mb-3">
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <p class="text-muted mb-1">{{ __('Produits') }}</p>
    ...
    <div class="col-12 col-md-6 col-xl-3 mb-3">
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <p class="text-muted mb-1">{{ __('Stock faible') }}</p>
...
<div class="row">
    <div class="col-lg-8 mb-4">
        <div class="card">
            <div class="card-header py-3 px-4 border-bottom d-flex justify-content-between align-items-center">
                <h5 class="fw-bold mb-0">{{ __('Commandes récentes') }}</h5>
                <a href="{{ route('admin.ecommerce.orders.index') }}" class="btn btn-primary btn-sm">{{ __('Voir tout') }}</a>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            @empty
                            <tr>
                                <td colspan="6" class="text-center text-muted py-4">{{ __('Aucune commande.') }}</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
    ...
    <div class="col-lg-4 mb-4">
        <div class="card">
            <div class="card-header py-3 px-4 border-bottom d-flex justify-content-between align-items-center">
                <h5 class="fw-bold mb-0">{{ __('Alertes stock') }}</h5>
                <a href="{{ route('admin.ecommerce.products.index') }}" class="btn btn-outline-primary btn-sm">{{ __('Gérer') }}</a>
            </div>
            <div class="card-body">
                @if($lowStockVariants->count() > 0)
                    <div class="list-group list-group-flush">
                        ...
                        <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                            <div>
                                ...
                                <small class="text-muted">{{ __('SKU') }} : {{ $variant->sku }}</small>
                            </div>
                    ...
                    @if($lowStockVariants->count() > 5)
                        <p class="text-center text-muted mt-3 mb-0">+ {{ $lowStockVariants->count() - 5 }} {{ __('autres') }}</p>
                    @endif
                @else
                    <div class="text-center py-4">
                        <i data-lucide="check-circle" class="icon-lg text-success mb-2"></i>
                        <p class="text-muted mb-0">{{ __('Stocks en ordre.') }}</p>
                    </div>
                @endif
            </div>
        </div>
