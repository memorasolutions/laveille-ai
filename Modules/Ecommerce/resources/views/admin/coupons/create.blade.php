...
@extends('backoffice::themes.backend.layouts.admin', ['title' => __('Nouveau coupon'), 'subtitle' => __('Boutique')])
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="type" id="couponType" class="form-select @error('type') is-invalid @enderror">
                                <option value="fixed" {{ old('type') === 'fixed' ? 'selected' : '' }}>{{ __('Montant fixe') }}</option>
                                <option value="percent" {{ old('type') === 'percent' ? 'selected' : '' }}>{{ __('Pourcentage (%)') }}</option>
