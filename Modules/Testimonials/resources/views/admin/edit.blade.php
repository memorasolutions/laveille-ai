...
@extends('backoffice::themes.backend.layouts.admin', ['title' => __('Modifier :') . ' ' . $testimonial->author_name, 'subtitle' => __('Témoignages')])
...
<div class="card">
    <div class="card-header py-3 px-4 border-bottom">
        <h5 class="fw-bold mb-0">{{ __('Modifier :') }} {{ $testimonial->author_name }}</h5>
    </div>
    <div class="card-body">
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('author_title') is-invalid @enderror" id="author_title" name="author_title" value="{{ old('author_title', $testimonial->author_title) }}" placeholder="{{ __('Ex: CEO de Entreprise X') }}">
