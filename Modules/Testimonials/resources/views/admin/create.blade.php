...
@extends('backoffice::themes.backend.layouts.admin', ['title' => 'Nouveau témoignage', 'subtitle' => 'Témoignages'])
...
<div class="card">
    <div class="card-header py-3 px-4 border-bottom">
        <h5 class="fw-bold mb-0">Nouveau témoignage</h5>
    </div>
    <div class="card-body">
        <form action="{{ route('admin.testimonials.store') }}" method="POST">
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('author_title') is-invalid @enderror" id="author_title" name="author_title" value="{{ old('author_title') }}" placeholder="Ex: CEO de Entreprise X">
            ...
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary">
                    <i data-lucide="save" class="me-1"></i> Enregistrer
                </button>
