@extends('backoffice::layouts.admin', ['title' => 'Import CSV', 'subtitle' => 'Pages'])
...
<div class="card">
    <div class="card-header d-flex align-items-center justify-content-between gap-3">
        <h6 class="mb-0">Importer des pages depuis un fichier CSV</h6>
        <div class="d-flex gap-2">
            <a href="{{ route('admin.import.template', 'pages') }}" class="btn btn-sm btn-outline-primary-600 d-flex align-items-center gap-2">
            ...
            <a href="{{ route('admin.plans.index') }}" class="btn btn-sm btn-secondary-600 d-flex align-items-center gap-2">
                <iconify-icon icon="solar:arrow-left-outline" class="icon text-xl"></iconify-icon> Retour
            </a>
        </div>
    </div>
    <div class="card-body">
        ...
        <div class="alert alert-info d-flex align-items-start gap-3 mb-24">
            ...
            <div>
                ...
                <p class="mb-2 text-sm">Colonnes dans cet ordre : <code>title, content, status</code></p>
                <p class="mb-2 text-sm">La 1ère ligne (en-tête) est ignorée. Le slug sert d'identifiant unique.</p>
                <p class="mb-0 text-sm">Le statut doit être <code>draft</code> ou <code>published</code> (défaut : draft).</p>
            </div>
        </div>
