@extends('backoffice::layouts.admin', ['title' => 'Catégories cookies', 'subtitle' => 'Modifier'])

@section('content')
<div class="card">
    <div class="card-header d-flex align-items-center justify-content-between">
        <h3 class="card-title">Modifier : {{ $category->label }}</h3>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('admin.cookie-categories.update', $category) }}">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="order" id="order" class="form-control" value="{{ old('order', $category->order) }}" min="0" style="max-width: 120px;">
            </div>
