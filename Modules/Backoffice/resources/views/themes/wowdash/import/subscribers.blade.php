...
<div class="card">
    <div class="card-header d-flex align-items-center justify-content-between gap-3">
        <h6 class="mb-0">Importer des abonnés depuis un fichier CSV</h6>
        <a href="{{ route('admin.newsletter.index') }}" class="btn btn-sm btn-secondary-600 d-flex align-items-center gap-2">
            <iconify-icon icon="solar:arrow-left-outline" class="icon text-xl"></iconify-icon> Retour aux abonnés
        </a>
    </div>
    <div class="card-body">
        ...
        <div class="alert alert-info d-flex align-items-start gap-3 mb-24">
            ...
            <div>
                ...
                <p class="mb-2 text-sm">Colonnes dans cet ordre : <code>email, name</code></p>
                <p class="mb-2 text-sm">La 1ère ligne (en-tête) est ignorée. L'email sert d'identifiant unique.</p>
                <p class="mb-0 text-sm">La colonne <code>name</code> est optionnelle. Les abonnés sont confirmés automatiquement à l'import.</p>
            </div>
        </div>
