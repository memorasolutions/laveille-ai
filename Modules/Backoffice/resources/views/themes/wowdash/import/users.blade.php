@extends('backoffice::layouts.admin', ['title' => 'Import CSV', 'subtitle' => 'Utilisateurs'])
...
<div class="card">
    <div class="card-header d-flex align-items-center justify-content-between gap-3">
        <h6 class="mb-0">Importer des utilisateurs depuis un fichier CSV</h6>
        <a href="{{ route('admin.users.index') }}" class="btn btn-sm btn-secondary-600 d-flex align-items-center gap-2">
    ...
    <div class="card-body">
        ...
        <div class="alert alert-info d-flex align-items-start gap-3 mb-24">
            ...
            <div>
                ...
                <p class="mb-2 text-sm">Colonnes dans cet ordre : <code>id, name, email, created_at</code></p>
                <p class="mb-2 text-sm">La 1ère ligne (en-tête) est ignorée. L'email sert d'identifiant unique.</p>
                <p class="mb-0 text-sm">Un mot de passe aléatoire est généré pour les nouveaux utilisateurs.</p>
            </div>
        </div>
