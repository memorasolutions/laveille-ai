@extends('backoffice::layouts.admin', ['title' => 'Rôles', 'subtitle' => 'Ajouter'])

@section('content')

<div class="card">
    <div class="card-header">
        <h6 class="mb-0">Ajouter un rôle</h6>
    </div>
    <div class="card-body">
                            ...
                            <div class="d-flex flex-wrap gap-3">
                                @foreach($category['permissions'] as $permName => $permMeta)
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="permissions[]" value="{{ $permMeta['model']->id }}" id="perm_{{ $permMeta['model']->id }}" @checked(in_array($permMeta['model']->id, old('permissions', [])))>
