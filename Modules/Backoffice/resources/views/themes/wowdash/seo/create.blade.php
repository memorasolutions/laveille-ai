@extends('backoffice::layouts.admin', ['title' => 'SEO', 'subtitle' => 'Nouveau tag'])

@section('content')
<div class="card">
    <div class="card-header">
        <h6 class="mb-0">Créer un tag SEO</h6>
    </div>
    <div class="card-body">
        <form method="POST" action="{{ route('admin.seo.store') }}">
            ...
            <div class="d-flex gap-3 mt-24">
                <button type="submit" class="btn btn-primary-600">Créer le tag</button>
