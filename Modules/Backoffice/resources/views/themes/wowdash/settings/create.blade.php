...
<div class="card" x-data="{
    ...
    <div class="card-header">
        <h6 class="mb-0">Nouveau paramètre</h6>
    </div>
    <div class="card-body">
        <form action="{{ route('admin.settings.store') }}" method="POST">
                ...
                <div class="col-12">
                    ...
                    <div x-show="selectedType === 'json'" x-cloak>
                        <textarea name="value" rows="4"
                                  ...
                                  class="form-control radius-8 font-monospace" style="font-size: 13px;">{{ old('value') }}</textarea>
                    </div>
            ...
            <div class="d-flex gap-3 mt-24">
                <button type="submit" class="btn btn-primary-600">Créer le paramètre</button>
