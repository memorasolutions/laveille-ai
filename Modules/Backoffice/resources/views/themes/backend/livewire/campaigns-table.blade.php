<div>
        ...
        <table class="table table-hover">
            <thead>
                <tr class="border-bottom">
                    ...
                    <th class="fw-medium">Sujet</th>
                    <th class="fw-medium">Statut</th>
                    <th class="fw-medium">Destinataires</th>
                    <th class="fw-medium">Envoyé le</th>
    ...
    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mt-3 pt-3 border-top">
        <span class="text-muted small">{{ $campaigns->total() }} campagne(s)</span>
        {{ $campaigns->links() }}
    </div>
</div>
