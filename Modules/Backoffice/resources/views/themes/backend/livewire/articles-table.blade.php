...
<div>
    ...
    @else
            ...
            <table class="table table-hover">
                <thead>
                    <tr class="border-bottom">
                        ...
                        <th class="fw-medium" style="width:64px">Image</th>
                        ...
                        <th class="fw-medium" style="width:112px">Statut</th>
                        <th class="fw-medium" style="width:128px">Catégorie</th>
                        <th class="fw-medium" style="width:128px">Auteur</th>
                        ...
                        <th class="fw-medium" style="width:144px">Actions</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($article->featured_image)
                                <img src="{{ Storage::url($article->featured_image) }}" class="rounded object-fit-cover" style="width:48px;height:48px" alt="">
                            @else
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 mt-3 pt-3 border-top">
            <span class="text-muted">{{ $articles->total() }} entrée(s)</span>
            {{ $articles->links() }}
        </div>
    @endif
</div>
