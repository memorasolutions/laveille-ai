...
<div>
        ...
        <table class="table table-hover">
            <thead>
                <tr class="border-bottom">
                    ...
                    <th class="fw-medium">Auteur</th>
                    <th class="fw-medium">Article</th>
                    <th class="fw-medium">Commentaire</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @else
                            <span class="text-muted small">Article supprimé</span>
                        @endif
                    </td>
    ...
    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mt-3 pt-3 border-top">
        <span class="text-muted small">{{ $comments->total() }} commentaire(s)</span>
        {{ $comments->links() }}
    </div>
</div>
