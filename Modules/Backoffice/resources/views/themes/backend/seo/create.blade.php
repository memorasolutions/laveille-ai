@extends('backoffice::themes.backend.layouts.admin', ['title' => 'SEO', 'subtitle' => 'Nouveau tag'])
...
<div class="card">
    <div class="card-header border-bottom py-3 px-4">
        <h4 class="fw-bold mb-0 d-flex align-items-center gap-2"><i data-lucide="plus-circle" class="icon-md text-primary"></i>Créer un tag SEO</h4>
    </div>
        ...
        <form method="POST" action="{{ route('admin.seo.store') }}">
            ...
            <div class="row g-4 mb-4">
                <div class="col-12 col-md-6">
                    ...
                    <div class="form-text">Utilisez <code>*</code> comme joker : <code>/blog/*</code></div>
                </div>
                <div class="col-12 col-md-6">
            ...
            <div class="row g-4 mb-4">
                ...
                <div class="col-12 col-md-4">
                    ...
                    <select class="form-select @error('robots') is-invalid @enderror"
                        ...
                        <option value="index, follow" @selected(old('robots', 'index, follow') === 'index, follow')>index, follow (défaut)</option>
