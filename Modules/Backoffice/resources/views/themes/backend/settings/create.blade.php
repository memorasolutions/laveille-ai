...
@extends('backoffice::themes.backend.layouts.admin', ['title' => __('Paramètres'), 'subtitle' => __('Ajouter')])
...
<div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-3">
    <h4 class="fw-bold mb-0 d-flex align-items-center gap-2"><i data-lucide="plus-circle" class="icon-md text-primary"></i>{{ __('Nouveau paramètre') }}</h4>
        ...
        <form action="{{ route('admin.settings.store') }}" method="POST">
                ...
                <div class="col-12">
                    ...
                    <div x-show="selectedType === 'boolean'" x-cloak>
                        <div class="form-check form-switch d-flex align-items-center gap-3">
                            ...
                            <input class="form-check-input" type="checkbox" role="switch"
                                   x-ref="boolToggle" {{ old('value') === 'true' ? 'checked' : '' }}>
                    ...
                    <div x-show="selectedType === 'json'" x-cloak>
                        <textarea name="value" rows="4"
                                  ...
                                  class="form-control font-monospace">{{ old('value') }}</textarea>
                    </div>
            ...
            <div class="d-flex align-items-center gap-3 mt-4">
                <button type="submit" class="btn btn-primary d-inline-flex align-items-center gap-2">
                    <i data-lucide="save"></i> {{ __('Créer le paramètre') }}
                </button>
                <a href="{{ route('admin.settings.index') }}" class="btn btn-sm btn-light d-inline-flex align-items-center gap-2">
