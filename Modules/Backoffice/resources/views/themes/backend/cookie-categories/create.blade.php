...
@extends('backoffice::themes.backend.layouts.admin', ['title' => __('Catégories cookies'), 'subtitle' => __('Créer')])
...
<div class="card">
    <div class="card-header border-bottom py-3 px-4">
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
            <h5 class="mb-0 fw-semibold">{{ __('Créer une catégorie cookie') }}</h5>
        ...
        <form method="POST" action="{{ route('admin.cookie-categories.store') }}">
            ...
            <div class="row g-4">
                ...
                <div class="col-12 col-md-6">
                    ...
                    @enderror
                    <div class="form-text">{{ __('Identifiant technique unique, lettres minuscules et tirets uniquement.') }}</div>
                </div>
