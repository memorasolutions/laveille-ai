...
@extends('backoffice::themes.backend.layouts.admin', ['title' => 'Catégories cookies', 'subtitle' => 'Créer'])
        ...
        <form method="POST" action="{{ route('admin.cookie-categories.store') }}">
            ...
            <div class="row g-4">
                ...
                <div class="col-12 col-md-6">
                    ...
                    @enderror
                    <div class="form-text">Identifiant technique unique, lettres minuscules et tirets uniquement.</div>
                </div>
