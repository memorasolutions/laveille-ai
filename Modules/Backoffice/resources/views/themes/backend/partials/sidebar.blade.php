...
<nav class="sidebar" aria-label="{{ __('Menu administration') }}" style="background:var(--sidebar-bg, #0c1427);">
    ...
    <div class="sidebar-body">
        <ul class="nav" id="sidebarNav">
            ...
            {{-- ===== 2. CONTENU ===== --}}
            @canany(['view_articles', 'view_pages', 'view_media', 'view_categories', 'view_comments', 'view_faqs', 'view_testimonials', 'view_forms'])
            <li class="nav-item nav-category">{{ __('Contenu') }}</li>
            <li class="nav-item {{ request()->routeIs('admin.blog.*', 'admin.pages.*', 'admin.media.*', 'admin.faqs.*', 'admin.testimonials.*', 'admin.formbuilder.*', 'admin.blog.comments.*', 'admin.blog.tags.*') ? 'active' : '' }}">
                <a class="nav-link" data-bs-toggle="collapse" href="#contentMenu" role="button"
                   aria-expanded="{{ request()->routeIs('admin.blog.*', 'admin.pages.*', 'admin.media.*', 'admin.faqs.*', 'admin.testimonials.*', 'admin.formbuilder.*', 'admin.blog.comments.*', 'admin.blog.tags.*') ? 'true' : 'false' }}">
                    <i class="link-icon" data-lucide="file-text"></i>
                    <span class="link-title">{{ __('Contenu') }}</span>
                    <i class="link-arrow" data-lucide="chevron-down"></i>
                </a>
                <div class="collapse {{ request()->routeIs('admin.blog.*', 'admin.pages.*', 'admin.media.*', 'admin.faqs.*', 'admin.testimonials.*', 'admin.formbuilder.*', 'admin.blog.comments.*', 'admin.blog.tags.*') ? 'show' : '' }}" id="contentMenu" data-bs-parent="#sidebarNav">
            ...
            @canany(['view_ecommerce', 'view_products', 'view_ecommerce_orders', 'view_coupons', 'view_plans'])
            <li class="nav-item nav-category">{{ __('Ventes') }}</li>
            <li class="nav-item {{ request()->routeIs('admin.ecommerce.*', 'admin.plans.*', 'admin.revenue') ? 'active' : '' }}">
                <a class="nav-link" data-bs-toggle="collapse" href="#salesMenu" role="button"
                   aria-expanded="{{ request()->routeIs('admin.ecommerce.*', 'admin.plans.*', 'admin.revenue') ? 'true' : 'false' }}">
                    <i class="link-icon" data-lucide="shopping-cart"></i>
                    <span class="link-title">{{ __('Ventes') }}</span>
                    <i class="link-arrow" data-lucide="chevron-down"></i>
                </a>
                <div class="collapse {{ request()->routeIs('admin.ecommerce.*', 'admin.plans.*', 'admin.revenue') ? 'show' : '' }}" id="salesMenu" data-bs-parent="#sidebarNav">
                    <ul class="nav sub-menu">
                        @if(Route::has('admin.ecommerce.dashboard'))
                        @can('view_ecommerce')
                        <li class="nav-item"><a href="{{ route('admin.ecommerce.dashboard') }}" class="nav-link {{ request()->routeIs('admin.ecommerce.dashboard') ? 'active' : '' }}" {{ request()->routeIs('admin.ecommerce.dashboard') ? 'aria-current=page' : '' }}>{{ __('Boutique') }}</a></li>
                        @endcan
                        @endif
            ...
            <li class="nav-item {{ request()->routeIs('admin.booking.*') ? 'active' : '' }}">
                ...
                <div class="collapse {{ request()->routeIs('admin.booking.*') ? 'show' : '' }}" id="bookingMenu" data-bs-parent="#sidebarNav">
                    <ul class="nav sub-menu">
                        ...
                        @can('manage_booking')
                        <li class="nav-item">
                            <a class="nav-link text-muted" data-bs-toggle="collapse" href="#bookingMore" role="button" aria-expanded="false">
                                <i data-lucide="more-horizontal" style="width:14px;height:14px;"></i> {{ __('Plus...') }}
                            </a>
                            <div class="collapse" id="bookingMore">
                                <ul class="nav sub-menu">
            ...
            {{-- ===== 6. CONFIGURATION ===== --}}
            @canany(['view_settings', 'view_branding', 'view_seo', 'view_translations', 'view_email_templates', 'view_widgets', 'view_menus'])
            <li class="nav-item nav-category">{{ __('Configuration') }}</li>
            <li class="nav-item {{ request()->routeIs('admin.branding.*', 'admin.seo.*', 'admin.translations.*', 'admin.email-templates.*', 'admin.menus.*', 'admin.widgets.*', 'admin.announcements.*') ? 'active' : '' }}">
                <a class="nav-link" data-bs-toggle="collapse" href="#configMenu" role="button"
                   aria-expanded="{{ request()->routeIs('admin.branding.*', 'admin.seo.*', 'admin.translations.*', 'admin.email-templates.*', 'admin.menus.*', 'admin.widgets.*', 'admin.announcements.*') ? 'true' : 'false' }}">
                    <i class="link-icon" data-lucide="settings"></i>
                    <span class="link-title">{{ __('Configuration') }}</span>
                    <i class="link-arrow" data-lucide="chevron-down"></i>
                </a>
                <div class="collapse {{ request()->routeIs('admin.branding.*', 'admin.seo.*', 'admin.translations.*', 'admin.email-templates.*', 'admin.menus.*', 'admin.widgets.*', 'admin.announcements.*') ? 'show' : '' }}" id="configMenu" data-bs-parent="#sidebarNav">
                    <ul class="nav sub-menu">
            ...
            {{-- ===== 7. SYSTÈME ===== --}}
            @canany(['view_health', 'manage_system', 'view_security', 'view_backups', 'view_activity_logs', 'view_logs', 'view_notifications', 'view_trash'])
            <li class="nav-item nav-category">{{ __('Système') }}</li>
            <li class="nav-item {{ request()->routeIs('admin.health', 'admin.health.*', 'admin.security', 'admin.blocked-ips.*', 'admin.login-history', 'admin.backups.*', 'admin.activity-logs.*', 'admin.logs', 'admin.cache', 'admin.notifications.*', 'admin.trash.*', 'admin.system-info', 'admin.failed-jobs.*', 'admin.scheduler', 'admin.mail-log', 'admin.data-retention', 'admin.feature-flags.*', 'admin.experiments.*', 'admin.plugins.*', 'admin.webhooks.*', 'admin.shortcodes.*', 'admin.short-urls.*', 'admin.cookie-categories.*', 'admin.custom-fields.*', 'admin.import.*', 'admin.push-notifications.*', 'admin.storage.*', 'admin.onboarding-steps.*', 'admin.email-preview.*') ? 'active' : '' }}">
                <a class="nav-link" data-bs-toggle="collapse" href="#systemMenu" role="button"
                   aria-expanded="{{ request()->routeIs('admin.health', 'admin.security', 'admin.backups.*', 'admin.activity-logs.*', 'admin.logs', 'admin.cache', 'admin.notifications.*', 'admin.trash.*') ? 'true' : 'false' }}">
                    <i class="link-icon" data-lucide="shield"></i>
                    <span class="link-title">{{ __('Système') }}</span>
                    <i class="link-arrow" data-lucide="chevron-down"></i>
                </a>
                <div class="collapse {{ request()->routeIs('admin.health', 'admin.health.*', 'admin.security', 'admin.blocked-ips.*', 'admin.login-history', 'admin.backups.*', 'admin.activity-logs.*', 'admin.logs', 'admin.cache', 'admin.notifications.*', 'admin.trash.*', 'admin.system-info', 'admin.failed-jobs.*', 'admin.scheduler', 'admin.mail-log', 'admin.data-retention', 'admin.feature-flags.*', 'admin.experiments.*', 'admin.plugins.*', 'admin.webhooks.*', 'admin.shortcodes.*', 'admin.short-urls.*', 'admin.cookie-categories.*', 'admin.custom-fields.*', 'admin.import.*', 'admin.push-notifications.*', 'admin.storage.*', 'admin.onboarding-steps.*', 'admin.email-preview.*') ? 'show' : '' }}" id="systemMenu" data-bs-parent="#sidebarNav">
                    <ul class="nav sub-menu">
                        @can('view_health')
                        ...
                        <li class="nav-item"><a href="{{ route('admin.activity-logs.index') }}" class="nav-link {{ request()->routeIs('admin.activity-logs.*') ? 'active' : '' }}" {{ request()->routeIs('admin.activity-logs.*') ? 'aria-current=page' : '' }}>{{ __('Journaux') }}</a></li>
                        @endcan
                        @can('manage_system')
            ...
            <li class="nav-item {{ request()->routeIs('admin.ai.*') ? 'active' : '' }}">
                ...
                <div class="collapse {{ request()->routeIs('admin.ai.*') ? 'show' : '' }}" id="aiMenu" data-bs-parent="#sidebarNav">
                    <ul class="nav sub-menu">
                        ...
                        {{-- Priority+ : extras IA --}}
                        <li class="nav-item">
                            <a class="nav-link text-muted" data-bs-toggle="collapse" href="#aiMore" role="button" aria-expanded="false">
                                <i data-lucide="more-horizontal" style="width:14px;height:14px;"></i> {{ __('Plus...') }}
                            </a>
                            <div class="collapse" id="aiMore">
                                <ul class="nav sub-menu">
