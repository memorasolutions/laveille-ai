...
<div class="container-fluid">
    ...
    <div class="card radius-8 bordered mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.push-notifications.store') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="title" class="form-control radius-8" required maxlength="100">
                </div>
                <div class="mb-3">
                    <label class="form-label">Message</label>
                    <textarea name="body" class="form-control radius-8" rows="3" required maxlength="500"></textarea>
                </div>
                <div class="mb-3">
                    <label class="form-label">Lien (optionnel)</label>
                    <input type="url" name="url" class="form-control radius-8" placeholder="https://...">
                </div>
                <div class="mb-4">
                    <label class="form-label">Destinataires</label>
                    <select name="role" class="form-select radius-8">
                ...
                <button type="submit" class="btn btn-primary-600 radius-8">Envoyer</button>
            </form>
        </div>
    </div>
</div>
