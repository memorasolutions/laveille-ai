...
class BackofficeServiceProvider extends BaseModuleServiceProvider
{
    ...
    protected function registerLivewireComponents(): void
    {
        ...
        Livewire::component('backoffice-blocked-ips-table', BlockedIpsTable::class);
        Livewire::component('backoffice-categories-table', CategoriesTable::class);
        Livewire::component('backoffice-contact-messages-table', ContactMessagesTable::class);
        Livewire::component('backoffice-login-history-table', LoginHistoryTable::class);
        Livewire::component('backoffice-mail-log-table', MailLogTable::class);
        Livewire::component('backoffice-notifications-table', NotificationsTable::class);
        Livewire::component('backoffice-tags-table', TagsTable::class);
