...
class SettingsDatabaseSeeder extends Seeder
{
    public function run(): void
    {
        $defaults = [
            ...
            ['group' => 'ai', 'key' => 'ai.default_model', 'value' => 'openrouter/free', 'type' => 'string', 'description' => 'Modèle IA par défaut'],
            ['group' => 'ai', 'key' => 'ai.chatbot_model', 'value' => 'openrouter/free', 'type' => 'string', 'description' => 'Modèle pour le chatbot client'],
            ['group' => 'ai', 'key' => 'ai.content_model', 'value' => 'openrouter/free', 'type' => 'string', 'description' => 'Modèle pour la génération de contenu'],
            ['group' => 'ai', 'key' => 'ai.moderation_model', 'value' => 'openrouter/free', 'type' => 'string', 'description' => 'Modèle pour la modération'],
            ['group' => 'ai', 'key' => 'ai.seo_model', 'value' => 'openrouter/free', 'type' => 'string', 'description' => 'Modèle pour les suggestions SEO'],
            ...
            ['group' => 'ai', 'key' => 'ai.translation_model', 'value' => 'openrouter/free', 'type' => 'string', 'description' => 'Modèle OpenRouter utilisé pour la traduction automatique'],
