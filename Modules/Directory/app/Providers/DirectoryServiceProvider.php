...
class DirectoryServiceProvider extends ServiceProvider
{
    ...
    protected function registerCommands(): void
    {
        $this->commands([
            ...
            \Modules\Directory\Console\CheckLifecycleConsistencyCommand::class,
            ...
            \Modules\Directory\Console\EnrichRichFieldsCommand::class,
            ...
            \Modules\Directory\Console\Commands\BackfillScreenshotMastersCommand::class,
            \Modules\Directory\Console\Commands\DispatchMarginRecaptureCommand::class,
    ...
    protected function registerCommandSchedules(): void
    {
        $this->app->booted(function () {
            ...
            // S84 #38 — health-check schedule DÉSACTIVÉ (kill switch, incident emails dupliqués user)
