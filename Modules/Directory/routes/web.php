...
Route::middleware(['web', 'auth', \Modules\Core\Http\Middleware\EnsureIsAdmin::class, 'can:moderate_tools'])->prefix('admin/directory')->name('admin.directory.')->group(function () {
