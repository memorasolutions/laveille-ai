...
@section('title', __('Codes de secours 2FA'))

@section('content')

<div class="mb-4" style="max-width:600px;">
    <h1 class="fw-semibold mb-1">{{ __('Codes de secours') }}</h1>
    <p class="text-muted mb-0">{{ __("Utilisez ces codes si vous n'avez plus accès à votre application authenticator.") }}</p>
</div>
...
<div class="card mb-3" style="max-width:600px;">
    <div class="card-header">
        <h5 class="card-title fw-semibold mb-0 d-flex align-items-center gap-2">
            ...
            {{ __('Vos codes de secours') }}
        </h5>
    </div>
    <div class="card-body">
        <p class="text-muted text-sm mb-3">
            {{ __('Chaque code peut être utilisé une seule fois. Conservez-les dans un gestionnaire de mots de passe.') }}
        </p>
        ...
        <div class="border-top pt-3">
            <div class="alert alert-warning d-flex align-items-start gap-2 mb-3">
                ...
                <p class="mb-0 text-sm">{{ __('La régénération annulera tous les codes actuels. Mettez à jour vos sauvegardes.') }}</p>
            </div>
