...
@extends('backoffice::themes.backend.layouts.admin', ['title' => 'Nouvelle page', 'subtitle' => 'Pages statiques'])
            ...
            <div class="card mb-3">
                ...
                <div class="p-4">
                    <div class="mb-0">
                        ...
                        <input type="text" class="form-control" id="content_password" name="content_password" value="{{ old('content_password', '') }}" placeholder="Laisser vide pour accès libre">
                    </div>
                </div>
            </div>
