...
namespace Modules\Decido\Providers;
...
/**
 * ServiceProvider du module Decido (sondages collectifs, /decido).
 *
 * Squelette calqué sur BooksServiceProvider (pattern nwidart standard du projet).
 */
class DecidoServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = 'Decido';

    protected string $nameLower = 'decido';
