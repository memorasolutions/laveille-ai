        ...
        <div class="col-xl-8">
            <div class="card">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="mb-3">
                        <label for="seo_title" class="form-label fw-medium">Titre pour Google</label>
                        <input type="text" name="seo_title" id="seo_title"
                               class="form-control @error('seo_title') is-invalid @enderror"
                               value="{{ old('seo_title', $article->seo_title) }}" maxlength="70" autocomplete="off">
                        <div class="form-text text-muted">Remplace le titre affiché dans les résultats de recherche Google. Laissez vide pour utiliser le titre normal de l'article (60 caractères visés, 70 maximum).</div>
                        @error('seo_title')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
