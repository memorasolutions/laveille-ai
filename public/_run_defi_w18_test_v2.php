...
// One-shot self-deleting v2 : update défi W18 corrigé + envoi test newsletter complète
$logFile = __DIR__ . '/../_run_defi_w18_test_v2.log';
...
// Étape 0 : clear cache views (template modifié)
$step0 = runArtisan($artisan, 'view:clear', $logFile);
file_put_contents($logFile, "STEP0 code={$step0['code']} out={$step0['out']}" . PHP_EOL, FILE_APPEND);

// Étape 1 : update défi W18 (avec corrections + Gartner term_id)
...
// Étape 2 : envoi test newsletter complète
...
echo "DONE step0_code={$step0['code']} step1_code={$step1['code']} step2_code={$step2['code']}" . PHP_EOL;
