...
(function() {
    ...
    var config = {
        ...
        jurisdiction: (document.querySelector('meta[name="privacy-jurisdiction"]') || {}).content || 'pipeda',
    ...
    function saveConsent(choices) {
        // 1. Cookie local (feedback immédiat)
        setCookie(config.cookieName, JSON.stringify({choices: choices, v: config.policyVersion}), 365);
    ...
    var existing = readChoicesFromCookie();
    if (existing) {
