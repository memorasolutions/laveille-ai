...
{
    /**
     * POST /api/consent - Enregistre un nouveau consentement (art. 7 RGPD)
     */
    public function store(Request $request): JsonResponse
    {
        ...
        $cookie = Cookie::make(
            ...
            null,
            true,  // secure
            false, // httpOnly false pour accès JS
            false,
            'Lax'
        );
    ...
    /**
     * GET /api/consent/{token} - Récupère un consentement existant
     */
    ...
    /**
     * GET /api/cookie-list - Liste des cookies par catégorie
     */
